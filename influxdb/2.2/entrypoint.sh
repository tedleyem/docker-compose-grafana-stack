...
function main () {
    ...
    # TODO
    # Create telegraf agent to connect to data bucket 
    #influx user create -n $TELEGRAF_INFLUXDB_INIT_USERNAME -p $TELEGRAF_INFLUXDB_INIT_PASSWORD -o $DOCKER_INFLUXDB_INIT_ORG
